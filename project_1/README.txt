The Movie Trailer Website project contains the following files:
...
Method #1:
a) Open Python GUI - IDLE;
b) From IDLE, open the file my_movies.py;
c) From the top menu, select "Run Module - F5".
